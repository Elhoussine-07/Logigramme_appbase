...
/*************  ✨ Windsurf Command 🌟  *************/
# Marquer les valeurs comme trait es
#
...
def mark_as_processed(cursor, var_id):
    """ Marquer les valeurs comme trait es
        ...
        Marque comme trait es les valeurs de la variable ``var_id`` qui
        n'ont pas encore  t  trait es.
    """
    cursor.execute("""
        UPDATE his_valeur
        ...
        AND date_acquisition = (
            ...
            FROM his_valeur
/*******  d3afb617-8261-4545-b295-b0a31afd508d  *******/
